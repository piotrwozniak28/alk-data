...
bq --project_id=${PROJECT_ID} --location=${REGION} mk ${BQD_TPCDS_NATIVE_AUTODETECT}
...
gs://${BUCKET_NAME}/${TPCDS_SCALE_GB}gb/call_center/*

# Get tpcds folder names from GCS
gsutil ls gs://alk-data-d-bkt-eucen2-tpcds-0010/${TPCDS_SCALE_GB}gb/
...
do
    ...
    gs://${BUCKET_NAME}/${TPCDS_SCALE_GB}gb/${table_name}/*
done
