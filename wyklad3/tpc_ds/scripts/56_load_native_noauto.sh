...
bq --project_id=${PROJECT_ID} --location=${REGION} mk ${BQD_TPCDS_NATIVE_NOAUTODETECT}

bq --project_id=${PROJECT_ID} load --field_delimiter '|' --null_marker '' --ignore_unknown_values ${BQD_TPCDS_NATIVE_NOAUTODETECT}.call_center gs://${BUCKET_NAME}/${TPCDS_SCALE_GB}gb/call_center/* \
